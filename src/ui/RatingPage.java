        ...
        public static void main(String[] args) {
                ...
                btnSubmit.addActionListener(e -> {
                        try {
                                ...
                                int ratingValue = Integer.parseInt((String) ratingBox.getSelectedItem());
                                ...
                                if (completedRide == null) {
                                        JOptionPane.showMessageDialog(frame, "Completed Ride Not Found!");
                                        return;
                                }
                                RatingManager manager = new RatingManager();
                                if (manager.isRideAlreadyRated(rideId)) {
                                        JOptionPane.showMessageDialog(frame, "This Ride is Already Rated!");
                                        return;
                                }
                                Rating rating = new Rating(RatingManager.generateRatingId(), rideId,
                                                LoginManager.currentUserEmail, ratingValue, review);
