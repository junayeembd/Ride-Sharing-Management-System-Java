...
public class AdminDashboard {
    public static void main(String[] args) {
        ...
        viewUsers.setBounds(200, 100, 180, 40);

        JButton viewDrivers = new JButton("View Drivers");
        viewDrivers.setBounds(200, 160, 180, 40);

        JButton viewRides = new JButton("View All Rides");
        viewRides.setBounds(200, 220, 180, 40);

        JButton viewPayments = new JButton("View Payments");
        viewPayments.setBounds(200, 280, 180, 40);
        ...
        logout.setBounds(200, 400, 180, 40);
