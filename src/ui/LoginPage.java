...
public class LoginPage {
    public static void main(String[] args) {
        ...
        btnLogin.addActionListener(e -> {
            ...
            if (role.equals("User")) {
                success = manager.userLogin(email, password);

            } else if (role.equals("Driver")) {
                success = manager.driverLogin(email, password);
            } else if (role.equals("Admin")) {
                success = manager.adminLogin(email, password);
            }
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(frame, "Invalid " + role + " Login Information!");
            }
        });
