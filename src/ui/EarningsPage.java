...
public class EarningsPage {
        public static void main(String[] args) {
                ...
                JLabel rideLabel = new JLabel("Completed Rides : " + completedRides);
                rideLabel.setBounds(180, 110, 250, 30);

                JLabel earningsLabel = new JLabel("Total Earnings : " + totalEarnings + " BDT");

                earningsLabel.setBounds(180, 170, 250, 30);

                JButton btnBack = new JButton("Back");
                btnBack.setBounds(230, 250, 120, 35);
