        ...
        public static void main(String[] args) {
                ...
                btnRegister.addActionListener(e -> {
                        ...
                        if (name.isEmpty() || phone.isEmpty() || email.isEmpty() || address.isEmpty()
                                        || drivingLicense.isEmpty() || vehicleNo.isEmpty() || password.isEmpty()) {
                        ...
                        Driver driver = new Driver(name, phone, email, address, vehicleType, drivingLicense, vehicleNo,
                                        password);
                        RegisterManager manager = new RegisterManager();
                        manager.registerDriver(driver);

                        JOptionPane.showMessageDialog(frame, "Driver Registration Successful!");
                        frame.dispose();
                        LoginPage.main(null);
                });
